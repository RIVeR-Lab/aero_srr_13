...

{
	...
	image_left_  = it_.subscribeCamera("/stereo_camera_raw/left/image_raw", 1, &ImageConverter::imageCbLeft, this);
	image_right_ = it_.subscribeCamera("/stereo_camera_raw/right/image_raw", 1, &ImageConverter::imageCbRight, this);
