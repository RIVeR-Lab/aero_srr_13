"""autogenerated by genpy from action_test/TestAction.msg. Do not edit."""
import sys
...
class TestAction(genpy.Message):
  _md5sum = "67694161c7e41f96811dc6e433a2f855"
  _type = "action_test/TestAction"
...
"""
  ...
  _slot_types = ['action_test/TestActionGoal','action_test/TestActionResult','action_test/TestActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = action_test.msg.TestActionGoal()
      if self.action_result is None:
        self.action_result = action_test.msg.TestActionResult()
      if self.action_feedback is None:
        self.action_feedback = action_test.msg.TestActionFeedback()
    else:
      self.action_goal = action_test.msg.TestActionGoal()
      self.action_result = action_test.msg.TestActionResult()
      self.action_feedback = action_test.msg.TestActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.request, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.request, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.progress,) = _struct_i.unpack(str[start:end])
      return self
