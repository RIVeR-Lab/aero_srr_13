"""autogenerated by genpy from action_test/TestActionResult.msg. Do not edit."""
import sys
...
class TestActionResult(genpy.Message):
  ...
  _type = "action_test/TestActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_test/TestResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_test.msg.TestResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_test.msg.TestResult()
