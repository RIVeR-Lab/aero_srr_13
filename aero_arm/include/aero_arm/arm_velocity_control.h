...
#include <aero_arm/AeroArmVelocityConfig.h>
...
public:
	...
	~Velocity_Controller();
private:
	void callback(aero_arm::AeroArmVelocityConfig &config, uint32_t level);
	...
	tf::TransformListener tf_listener;
	  ...
	  dynamic_reconfigure::Server<aero_arm::AeroArmVelocityConfig> server;
	  dynamic_reconfigure::Server<aero_arm::AeroArmVelocityConfig>::CallbackType f;
