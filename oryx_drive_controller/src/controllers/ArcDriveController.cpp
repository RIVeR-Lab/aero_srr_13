 ...
 */
void ArcDriveController::calculateTankSteer(double velocity, double radius, std::vector<double>& result){
 ...
 */
void ArcDriveController::calculateSwerveTankSteer(double velocity, double radius, std::vector<double>& result){
 ...
 */
void ArcDriveController::calculateSwerveTranslate(double xVelocity, double yVelocity, std::vector<double>& result){
