"""autogenerated by genpy from oryx_drive_controller/VelocityCommandAction.msg. Do not edit."""
import sys
...
class VelocityCommandAction(genpy.Message):
  _md5sum = "004ff1c1ba48466ede1224d1cdfb2b56"
  _type = "oryx_drive_controller/VelocityCommandAction"
...
"""
  ...
  _slot_types = ['oryx_drive_controller/VelocityCommandActionGoal','oryx_drive_controller/VelocityCommandActionResult','oryx_drive_controller/VelocityCommandActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(VelocityCommandAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = oryx_drive_controller.msg.VelocityCommandActionGoal()
      if self.action_result is None:
        self.action_result = oryx_drive_controller.msg.VelocityCommandActionResult()
      if self.action_feedback is None:
        self.action_feedback = oryx_drive_controller.msg.VelocityCommandActionFeedback()
    else:
      self.action_goal = oryx_drive_controller.msg.VelocityCommandActionGoal()
      self.action_result = oryx_drive_controller.msg.VelocityCommandActionResult()
      self.action_feedback = oryx_drive_controller.msg.VelocityCommandActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d3I.pack(_x.action_goal.goal.velocity, _x.action_goal.goal.radius, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d.pack(_x.action_feedback.feedback.velocity, _x.action_feedback.feedback.omega))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.velocity, _x.action_goal.goal.radius, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.velocity, _x.action_feedback.feedback.omega,) = _struct_2d.unpack(str[start:end])
      return self
