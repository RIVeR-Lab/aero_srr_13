...
(cl:defmethod cl:initialize-instance :after ((m <SoftwareStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SoftwareStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name oryxsrr_msgs-msg:<SoftwareStop> is deprecated: use oryxsrr_msgs-msg:SoftwareStop instead.")))
...
(cl:defmethod stop-val ((m <SoftwareStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader oryxsrr_msgs-msg:stop-val is deprecated.  Use oryxsrr_msgs-msg:stop instead.")
  (stop m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <SoftwareStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader oryxsrr_msgs-msg:message-val is deprecated.  Use oryxsrr_msgs-msg:message instead.")
  (message m))
