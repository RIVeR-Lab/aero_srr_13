...
//License File
#include <visual_servo/base_servo.h>

using namespace visual_servo;

Base_Servo::Base_Servo(ros::NodeHandle nh, std::string ObjectPose,
		std::string ArmPose) {

	this->sub_object_position = nh.subscribe(ObjectPose, 1,
			&Base_Servo::ObjectPosition, this);
...
void Base_Servo::ObjectPosition(
...
//create the arm object
	Base_Servo arm(nh, ObjectPose, ArmPose);
